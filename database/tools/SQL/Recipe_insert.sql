...
WITH new_recipe AS (
    INSERT INTO "DBA_human".all_recipes (
        diet,
		name,
        instructions,
        url,
...
INSERT INTO "DBA_human".recipe_ingredients (recipe_id, ingredient_id, quantity, unit)
SELECT
    new_recipe.id,
    i."ID",
    ing.quantity,
...
JOIN "DBA_human"."Ingredients" i ON i."Name" = ing.name
RETURNING recipe_id;
