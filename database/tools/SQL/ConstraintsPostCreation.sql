...
ALTER TABLE IF EXISTS dev_dba.all_recipes
    ...
    FOREIGN KEY (author) REFERENCES dev_dba.users(name) ON UPDATE CASCADE;
...
ALTER TABLE IF EXISTS public.pending_recipes
    ...
    FOREIGN KEY (author) REFERENCES dev_dba.users(name) ON DELETE CASCADE ON UPDATE CASCADE;